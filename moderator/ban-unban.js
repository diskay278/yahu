module.exports = [{
    name:"ban",
    $if: "v4",
    code: `$ban[$guildID;$findUser[$message[1];yes];0;Diban oleh $userTag ($authorID) - Alasan: $replaceText[$replaceText[$checkCondition[$message[2]==];true;Tanpa Alasan];false;$message[2]]
    ]
   $color[Red]
    $description[1;<@$findUser[$message[1];yes]> Telah DiBanned
    Alasan: $replaceText[$replaceText[$checkCondition[$message[2]==];true;Tanpa Alasan];false;$message[2]]]
